...
const CDN = {
  ...
  hljsCarveJs: 'https://cdn.jsdelivr.net/gh/markup-carve/carve-grammars@e19b94c5/highlightjs/carve.js',
  ...
  hljsTableCss: 'https://cdn.jsdelivr.net/gh/markup-carve/carve-grammars@e19b94c5/shiki/table-tokens.css',
} as const
